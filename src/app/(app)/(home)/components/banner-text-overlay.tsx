...
export function BannerTextOverlay() {
  return (
    <div className="absolute inset-0 z-200 flex max-w-[508px] flex-col justify-end rounded bg-opacity-50 p-4 text-zinc-100 md:left-16 md:justify-center md:text-zinc-900">
      <h1 className="mx-auto text-pretty text-center font-bold text-4xl md:mx-0 lg:text-5xl">
      ...
      <p className=" mt-1 text-pretty text-center font-semibold text-xl text-zinc-300 md:hidden">
